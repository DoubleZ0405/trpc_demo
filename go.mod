...
replace github.com/DoubleZ0405/trpc_demo/helloworld => ./stub/github.com/DoubleZ0405/trpc_demo/helloworld

require (
	github.com/DoubleZ0405/trpc_demo/helloworld v0.0.0-00010101000000-000000000000
